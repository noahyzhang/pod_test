...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/noahyzhang/pod_test'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'noahyzhang' => 'noahyzhang@tencent.com' }
  s.source           = { :git => 'https://github.com/noahyzhang/pod_test.git', :tag => s.version.to_s }
